...
export const site = {
  name: "鱼七图床",
  desc: "感谢每一份打赏，鱼七图床免费为你服务。",
  url: "https://www.y7img.ccwu.cc",
  avatar: "https://www.y7img.ccwu.cc/file/1788947795658_logo-Y7img500.png",
  Telegram: "@No777777777",
};
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              <p class="font-semibold text-sm mb-1">评论区留言/发送申请消息至：<code class="px-1.5 py-0.5 rounded bg-black/5 dark:bg-white/10 text-[0.7rem]">{site.TG：@No777777777}</code></p>
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">申请模板，把内容复制修改后到评论区或Telegram中发送</p>
