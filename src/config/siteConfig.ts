...
export const siteConfig: SiteConfig = {
	...
	// 站点 URL
	site_url: "https://y7ai.ccwu.cc",

	// 站点描述
	description:
		"这是我的第一个网站，如果你对外面的世界一无所知，那么这里很适合你，我们可以一起成长，我会在这里聊聊区块链和AI，当然也会把赚钱渠道和好用的工具分享给你",
	...
	favicon: [
		{
			// 图标文件路径（public 目录下的文件挂在站点根路径，不要带 /public 前缀）
			 src: "/favicon/fish-32.png",
			// 可选，指定主题 'light' | 'dark'
			// theme: "light",
			// 可选，图标大小
			 sizes: "32x32",
